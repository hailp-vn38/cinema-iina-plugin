...
```text
dist/releases/Cinema Sources-1.0.1.iinaplgz
```
...
2. Nếu chưa phát media, vào `Plugin -> Open Cinema` để mở standalone window của plugin.
3. Nếu đã có player window, bạn vẫn có thể mở tab sidebar `Cinema`.
...
- Plugin package: `dist/releases/Cinema Sources-1.0.1.iinaplgz`
